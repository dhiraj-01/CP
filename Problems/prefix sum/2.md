...
you are required to maximize the number of partitions of the given array such that after the partition, sum of left subarray = sum of right subarray. (partition can't be empty)
